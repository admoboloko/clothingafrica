  ...
  return (
    <View className="flex-row max-w-[250px] py-2 mr-6 max-h-[160px] overflow-hidden bg-[#c7c7c7] rounded-2xl">
      <View className="px-4 py-2">
        <Text className="font-extrabold text-2xl">Showcase Your Unique African Style</Text>
        <Text className="text-lg">Charm your viewers</Text>
        <Text className="text-xs my-2">Home for stunning designs</Text>
